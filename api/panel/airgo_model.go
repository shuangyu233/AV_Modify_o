...
type NodeInfoResponse struct {
	...
	//
	HyPorts        string `json:"hy_ports"     `
	HyUpMbps       int64  `json:"hy_up_mbps" `
	HyDownMbps     int64  `json:"hy_down_mbps" `
	HyObfs         string `json:"hy_obfs"`
	HyObfsPassword string `json:"hy_obfs_password"`
}
type Access struct {
	ID    int64  `json:"id"`
...
type UserTrafficRequest struct {
	ID          int               `json:"id"`
	UserTraffic []UserTrafficItem `json:"user_traffic"`
}
