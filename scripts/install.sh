...
currentVersion=''
latestVersion=''
downloadPrefix='https://github.com/AirGo-Official/AV/releases/download/'
githubApi="https://api.github.com/repos/AirGo-Official/AV/releases/latest"
manageScript="https://raw.githubusercontent.com/AirGo-Official/AV/main/scripts/install.sh"
